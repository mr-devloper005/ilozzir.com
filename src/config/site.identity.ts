export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'ilozzir',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Ilozzir',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'ilozzir.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://ilozzir.com',
